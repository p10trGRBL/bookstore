...
class BooksControllerTest @Autowired constructor(
    ...
    @Test
    fun `test that createFullUpdateBook return http 500 when author in the database doesn't have an id`() {
        val isbn = "978-089-230342-0777"
    ...
    fun `test that list returns book when matches author id`() {
        ...
        every {
            ...
            listOf(testBookEntityA(isbn = isbn, testAuthorEntityA(1L)))
        }
    ...
    @Test
    fun `test that deleteBook deletes book successfully`() {
        every {
